...
const CHAR_GROUPS = [
  ...
  { label: '漢字3年', chars: '丁世両主乗予事仕他代住使係倍全具写列助勉動勝化区医去反取受号向君味命和品員商問坂央始委守安定実客宮宿寒対届岸島州帳平幸度庫庭式役待急息悪悲想意感所打投拾持指放整旅族昔暑暗曲有様横次歯死氷決油波注洋消深温港湖畑等筆箱級終緑練羊美習者育苦荒薬血表詩調豆負起路身転軽農返追送遊運部都配酒重鉄銀開院陽階集面' },
  { label: '漢字4年', chars: '以付令加努労倉候借値健側働億児共典協司各告周唇喜器困囲堂塩士変夫失好季孫完官害察差席帯底延建径徒得必志念成戦折挙旗最材松梅械機欠歴残毒民治法浄満漁灯無然照特産的省祖禁種積究章笑紀約結給続置老胃脈芸英菜街衣要試説課議象貨貯資賞軍輪辺迎達選飯飛養験料' },
  { label: '漢字5年', chars: '久仲件任似余価圧句可団墓導布師常幹弁張往復徳応態慣承技招条検権武比永河液減準演版犯状現留略益眼確示祖禁税移程精絹経総編織耕能許設証評講賀質輸述迫退造過適防限領統護制厚報恩格桜構混測率築績豊貧責貿際' },
  { label: '漢字6年', chars: '並乳仮値割創劇勤券厳呼吸善奮存孝宅宇宙宗尺射専層己幕干庁後律復我探推揮操故敬日映晩権樹欲段毒氷沙済源潮激灯片獲玄皇盛碑立竭筋簡純納縦繁胸脳腕臣著蒸蔵託診誌認論諦警豪貴賀賢贈辞遅遣遺郵郷針鋳閉陣難革頂骨' },
];
