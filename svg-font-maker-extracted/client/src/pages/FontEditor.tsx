...
export default function FontEditor() {
  ...
  useEffect(() => {
    ...
    const ff = new FontFace(familyName, `url('${fontUrl}?v=${fontFamilyKey}')`);
      ...
      <div className="flex-1 overflow-auto">
        ...
        {activeTab === "preview" && (
          <div className="p-8">
            ...
            {fontUrl ? (
              <>
                <div className="border-3 border-black p-8 brutal-shadow-lg min-h-40 bg-white overflow-auto">
                  <div
                    style={{
                      fontFamily: loadedFontFamily ? `'${loadedFontFamily}', monospace` : "monospace",
                ...
                <div className="mt-6 flex gap-4 flex-wrap">
                  ...
                  <button
                    onClick={() => {
                      setActiveTab("glyphs");
                      toast.info("Upload more glyphs, then regenerate.");
                    }}
